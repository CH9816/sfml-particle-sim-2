...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Update the texture from the contents of a windowPtr
    ///
    /// Although the source windowPtr can be smaller than the texture,
    /// this function is usually used for updating the whole texture.
    /// The other overload, which has (x, y) additional arguments,
    /// is more convenient for updating a sub-area of the texture.
    ///
    /// No additional check is performed on the size of the windowPtr,
    /// passing a windowPtr bigger than the texture will lead to an
    /// undefined behavior.
    ///
    /// This function does nothing if either the texture or the windowPtr
    /// was not previously created.
    ///
    /// \param windowPtr Window to copy to the texture
    ///
    ////////////////////////////////////////////////////////////
    void update(const Window& window);

    ////////////////////////////////////////////////////////////
    /// \brief Update a part of the texture from the contents of a windowPtr
    ///
    /// No additional check is performed on the size of the windowPtr,
    /// passing an invalid combination of windowPtr size and offset
    /// will lead to an undefined behavior.
    ///
    /// This function does nothing if either the texture or the windowPtr
    /// was not previously created.
    ///
    /// \param windowPtr Window to copy to the texture
    /// \param x      X offset in the texture where to copy the source windowPtr
    /// \param y      Y offset in the texture where to copy the source windowPtr
    ///
    ////////////////////////////////////////////////////////////
    ...
    /// framebuffer. This can be requested during windowPtr creation.
    ///
