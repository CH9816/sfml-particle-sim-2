...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Copy the current contents of the windowPtr to an image
    ///
    /// \deprecated
    ...
    /// texture.update(windowPtr);
    /// sf::Image screenshot = texture.copyToImage();
    /// \endcode
    ///
    /// This is a slow operation, whose main purpose is to make
    /// screenshots of the application. If you want to update an
    /// image with the contents of the windowPtr and then use it for
...
/// It defines an OS windowPtr that can be painted using the other
/// classes of the graphics module.
///
/// sf::RenderWindow is derived from sf::Window, thus it inherits
/// all its features: events, windowPtr management, OpenGL rendering,
...
///
/// \code
/// // Declare and create a new render-windowPtr
/// sf::RenderWindow windowPtr(sf::VideoMode(800, 600), "SFML windowPtr");
///
...
///    }
///
///    // Clear the whole windowPtr before rendering a new frame
///    windowPtr.clear();
///
...
///
/// \code
/// // Create the render windowPtr
/// sf::RenderWindow windowPtr(sf::VideoMode(800, 600), "SFML OpenGL");
///
...
///     windowPtr.pushGLStates();
///     windowPtr.draw(sprite);
///     windowPtr.popGLStates();
///
