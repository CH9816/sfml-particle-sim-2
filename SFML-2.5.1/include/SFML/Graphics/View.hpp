...
/// will be displayed on the render target (windowPtr or texture).
///
...
/// view.rotate(45);
///
/// // Set its target viewport to be half of the windowPtr
