...
public:
    ...
    {
        int x; ///< X position of the mouse pointer, relative to the left of the owner windowPtr
        int y; ///< Y position of the mouse pointer, relative to the top of the owner windowPtr
    };
    ...
    struct TouchEvent
    {
        ...
        int x;               ///< X position of the touch, relative to the left of the owner windowPtr
        int y;               ///< Y position of the touch, relative to the top of the owner windowPtr
    };
    ...
    enum EventType
    {
        Closed,                 ///< The windowPtr requested to be closed (no data)
        Resized,                ///< The windowPtr was resized (data in event.size)
        LostFocus,              ///< The windowPtr lost the focus (no data)
        GainedFocus,            ///< The windowPtr gained the focus (no data)
        ...
        MouseEntered,           ///< The mouse cursor entered the area of the windowPtr (no data)
        MouseLeft,              ///< The mouse cursor left the area of the windowPtr (no data)
...
/// (mouse moved, key pressed, windowPtr closed, ...) as well
