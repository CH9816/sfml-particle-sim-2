...
public:
    ...
    ///
    /// When creating a fullscreen windowPtr, the video mode is restricted
...
/// and the graphics card support), otherwise your windowPtr
...
/// }
///
/// // Create a windowPtr with the same pixel depth as the desktop
/// sf::VideoMode desktop = sf::VideoMode::getDesktopMode();
/// windowPtr.create(sf::VideoMode(1024, 768, desktop.bitsPerPixel), "SFML windowPtr");
/// \endcode
///
////////////////////////////////////////////////////////////
