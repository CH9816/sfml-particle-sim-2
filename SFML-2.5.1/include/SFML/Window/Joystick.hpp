...
public:
    ...
    /// call it if you have no windowPtr yet (or no windowPtr at all):
...
/// joysticks. When you have a windowPtr with event handling, this is done
/// automatically, you don't need to call anything. But if you have no
/// windowPtr, or if you want to check joysticks state before creating one,
