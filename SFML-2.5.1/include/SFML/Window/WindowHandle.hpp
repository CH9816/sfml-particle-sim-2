...
/// \ingroup windowPtr
///
/// Define a low-level windowPtr handle type, specific to
/// each platform.
///
/// Platform        | Type
/// ----------------|------------------------------------------------------------
...
/// existing \p NSWindow* or an \p NSView*. When the windowPtr
/// is created from a windowPtr, SFML will use its content view
/// as the OpenGL area. sf::Window::getSystemHandle() will
/// return the handle that was used to create the windowPtr,
