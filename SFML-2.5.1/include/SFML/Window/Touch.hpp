...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Get the current position of a touch in windowPtr coordinates
    ///
    /// This function returns the current touch position
    /// relative to the given windowPtr.
    ///
    /// \param finger Finger index
...
/// happen when your windowPtr is out of focus and no event is triggered.
///
...
/// operates in windowPtr coordinates (relative to a specific windowPtr).
///
...
///
/// // get position of touch 1 relative to a windowPtr
/// sf::Vector2i relativePos = sf::Touch::getPosition(1, windowPtr);
/// \endcode
///
