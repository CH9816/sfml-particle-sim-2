...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Get the current position of the mouse in windowPtr coordinates
    ///
    /// This function returns the current position of the mouse
    /// cursor, relative to the given windowPtr.
    ///
    /// \param relativeTo Reference windowPtr
    ///
    /// \return Current position of the mouse
    ///
    ////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Set the current position of the mouse in windowPtr coordinates
    ///
...
/// time and directly, without having to deal with a windowPtr and
...
/// moved, pressed or released when your windowPtr is out of focus
...
/// to the desktop) and one that operates in windowPtr coordinates
/// (relative to a specific windowPtr).
///
/// Usage example:
/// \code
...
///
/// // set mouse position relative to a windowPtr
/// sf::Mouse::setPosition(sf::Vector2i(100, 200), windowPtr);
/// \endcode
///
